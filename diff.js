...
var WikEdDiff = function () {
	...
	this.config = {
		...
		'stylesheet':
			...
			'.wikEdDiffFragment:hover .wikEdDiffInsertBlank { background-color: lightgreen; } ' +

			// Delete
			'.wikEdDiffDelete {' +
			'font-weight: bold; background-color: lightcoral; ' +
			'color: #222; border-radius: 0.25em; padding: 0.2em 1px; ' +
			'} ' +
			'.wikEdDiffDeleteBlank { background-color: #ffd064; } ' +
			'.wikEdDiffFragment:hover .wikEdDiffDeleteBlank { background-color: lightcoral; } ' +
